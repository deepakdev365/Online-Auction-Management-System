...
public class SellerDao {
    ...
    public Seller validateSeller(String email, String password) {
        ...
        try (Connection con = DBUtil.getConnection();
            ...
            if (rs.next()) {
                ...
                // ✅ Important: fetch profile image path
                seller.setProfileImage(rs.getString("profile_image"));
            }
    ...
    public boolean registerSeller(Seller seller) {
        String sql = "INSERT INTO sellers (full_name, father_name, email, phone, password, company_name, company_location, address, document_type, document_path, profile_image) "
                   + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection con = DBUtil.getConnection();
            ...
            ps.setString(11, seller.getProfileImage()); // ✅ new
    ...
    // ✅ Update seller profile (for editing profile section)
    public boolean updateSellerProfile(Seller seller) {
        ...
        try (Connection con = DBUtil.getConnection();
            ...
            ps.setString(4, seller.getCompanyName());
            ps.setString(5, seller.getCompanyLocation());
            ps.setString(6, seller.getAddress());
            ps.setString(7, seller.getProfileImage());
    ...
    // ✅ Get seller details by email (used for profile page)
